...
#     ])
    ...
    if DATASET == 'CoNSeP/':
        ...
        train_idx = None
    train_dataset = CoNSeP_cropped(*data_reader(dataset=DATASET[:-1], root=f'{DATA_PATH}/{DATASET}', split='train', ver=VERSION, itr=ITERATION, doflip=True, contain_both=True, part=train_idx))
